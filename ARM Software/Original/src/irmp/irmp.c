        ...
        else
        {
            ...
            {                                                                   // ...and are counting the time of darkness
                ...
                {                                                               // receiving first data pulse!
                    const IRMP_PARAMETER * irmp_param_p;
...
#endif // ANALYZE
                        irmp_param_p = (const IRMP_PARAMETER *) &sircs_param;
                    }
                    else
                        ...
                        irmp_pause_time >= NEC_START_BIT_PAUSE_LEN_MIN && irmp_pause_time <= NEC_START_BIT_PAUSE_LEN_MAX)
                    {
                        ...
                        ANALYZE_PRINTF ("protocol = NEC, start bit timings: pulse: %3d - %3d, pause: %3d - %3d\n",
                                        ...
                                        NEC_START_BIT_PAUSE_LEN_MIN, NEC_START_BIT_PAUSE_LEN_MAX);
#endif // ANALYZE
                        irmp_param_p = (const IRMP_PARAMETER *) &nec_param;
#endif
                    }
                    ...
                    {                                                           // it's NEC
...
#endif // IRMP_SUPPORT_JVC_PROTOCOL == 1
                        {
                            ...
                            irmp_param_p = (const IRMP_PARAMETER *) &nec_rep_param;
                        }
                    }
                    else
...
#endif // ANALYZE
                        irmp_param_p = (const IRMP_PARAMETER *) &samsung_param;
                    }
                    else
...
#endif // ANALYZE
                        irmp_param_p = (const IRMP_PARAMETER *) &kaseikyo_param;
                    }
                    else
...
print_timings (void)
{
    ...
    printf ("RCMM           1   %3d        %3d        %3d        %3d        %3d        %3d        %3d\n",
            (uint_fast8_t)(F_INTERRUPTS * RCMM32_START_BIT_PULSE_TIME), (uint_fast8_t)(F_INTERRUPTS * RCMM32_START_BIT_PAUSE_TIME),
            (uint_fast8_t)(F_INTERRUPTS * RCMM32_PULSE_TIME),
            (uint_fast8_t)(F_INTERRUPTS * RCMM32_00_PAUSE_TIME), (uint_fast8_t)(F_INTERRUPTS * RCMM32_01_PAUSE_TIME),
            (uint_fast8_t)(F_INTERRUPTS * RCMM32_10_PAUSE_TIME), (uint_fast8_t)(F_INTERRUPTS * RCMM32_11_PAUSE_TIME));
