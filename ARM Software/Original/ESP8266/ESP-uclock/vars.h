...
/*-------------------------------------------------------------------------------------------------------------------------------------------
 * hardware configuration word: 0 xxx FFF LLL WWW HHH
 *-------------------------------------------------------------------------------------------------------------------------------------------
 */
#define HW_STM32_MASK               (0x07 << 0)                         // 3 bits for microprocessor mask
#define HW_STM32_F103C8             (0x00 << 0)                         // 0: F103C8 BluePill Board, standard 8MHz osc.
#define HW_STM32_F401RE             (0x01 << 0)                         // 1: F401RE Nucleo, standard 8MHz osc.
#define HW_STM32_F411RE             (0x02 << 0)                         // 2: F411RE Nucleo, standard 8MHz osc.
#define HW_STM32_F446RE             (0x03 << 0)                         // 3: F446RE Nucleo, standard 8MHz osc.
#define HW_STM32_F407VE             (0x04 << 0)                         // 4: F407VE Black Board, standard 8MHz osc.
#define HW_STM32_F401CC             (0x05 << 0)                         // 5: F401CC BlackPill Board, 8MHz or 25MHz osc.
#define HW_STM32_F411CE             (0x06 << 0)                         // 6: F411CE BlackPill Board, 8MHz or 25MHz osc.
...
#define MAX_DISPLAY_ANIMATION_VARIABLES        32

extern uint8_t              max_display_animation_variables;

extern DISPLAY_ANIMATION    displayanimationvars[MAX_DISPLAY_ANIMATION_VARIABLES];
extern DISPLAY_ANIMATION *  get_display_animation_var (uint_fast8_t);
extern unsigned int         set_display_animation_name (uint_fast8_t, char *);
extern unsigned int         set_display_animation_deceleration (uint_fast8_t, uint_fast8_t);
extern unsigned int         set_display_animation_default_deceleration (uint_fast8_t, uint_fast8_t);
extern unsigned int         set_display_animation_flags (uint_fast8_t, uint_fast8_t);
